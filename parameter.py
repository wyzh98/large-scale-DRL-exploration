...
NODE_RESOLUTION = 3.6  # meter, your node resolution
...
NODE_PADDING_SIZE = 550  # the number of nodes will be padded to this value, need it for batch training
