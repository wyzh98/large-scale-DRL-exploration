...
def main():
    ...
    if USE_WANDB:
        ...
        wandb.init(project='LargeScaleExploration', name=FOLDER_NAME, entity='ezo', config=vars(parameter), resume='allow',
                   id=None, notes=None)
...
def write_to_tensor_board(writer, tensorboard_data, curr_episode):
    ...
    (reward, value, policy_loss, q_value_loss, entropy, policy_grad_norm, q_value_grad_norm, log_alpha, alpha_loss,
     travel_dist, success_rate, explored_rate) = tensorboard_data
